...
class FollowingDialog extends StatelessWidget {
  const FollowingDialog({Key? key}) : super(key: key);
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          Row(
            ...
            children: [
              BoldText("Following", 17, AppColor.whiteColor, TextAlign.start),
              GestureDetector(
                onTap: (){
              ...
              child: Row(
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: MediumText("Unfollow", 15, AppColor.dialogBackColor, TextAlign.center),
                  )
                ],
              ),
            );
